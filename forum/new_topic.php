...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Главная страница форума</a> &gt; <a href="list_topics.php?parent=<?php echo $id; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Новая тема
    </div>
	<div class="box_right">
...
if(isset($_POST['message'], $_POST['title']) and $_POST['message']!='' and $_POST['title']!='')
{
	...
	{
	?>
	<div class="message">Тема успешно создана<br />
	<a href="list_topics.php?parent=<?php echo $id; ?>">Вернуться на форум</a></div>
	<?php
	}
	else
	{
...
<form action="new_topic.php?parent=<?php echo $id; ?>" method="post">
	<label for="title">Название</label><input type="text" name="title" id="title"  /><br />
...
{
	echo '<h2>Данная категория не определена</h2>';
}
?>